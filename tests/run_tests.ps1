...
$runtimeTests = @(
  ...
  [PSCustomObject]@{ Name = "renderer_backend_targets"; Sources = @("tests\\cases\\runtime\\renderer_backend_targets.lsc"); Expected = "true`ntrue`ntrue`ntrue`ntrue`ntrue`ntrue`ntrue`ndirectx11`ntrue`ndirectx12`ntrue`nfalse`ndirectx12" },
...
$cliInfoTests = @(
  ...
  [PSCustomObject]@{
    ...
    Args = @("--LineScript")
    Contains = "LineScript version 1.5.1c (Velocity update)"
  },
  [PSCustomObject]@{
