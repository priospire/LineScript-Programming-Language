...
private:
  ...
  std::string constructorFreeFnFromExpr(const Expr &e) const {
    ...
    if (c.f == "bitmap_new" || c.f == "bitmap_load") return "bitmap_free";
...
private:
  ...
  void addBuiltins() {
    ...
    addSig("task_hardware_threads", {}, Type::I64, s);
    addSig("task_set_worker_count", {Type::I64}, Type::Void, s);
    addSig("task_worker_count", {}, Type::I64, s);
    addSig("task_set_hyperthreading", {Type::Bool}, Type::Void, s);
    addSig("task_hyperthreading_enabled", {}, Type::Bool, s);
    ...
    addSig("gfx_draw_bitmap", {Type::I64, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("gfx_text", {Type::I64, Type::I64, Type::I64, Type::Str, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("gfx_text_width", {Type::Str}, Type::I64, s);
    addSig("bitmap_new", {Type::I64, Type::I64}, Type::I64, s);
    addSig("bitmap_load", {Type::Str}, Type::I64, s);
    addSig("bitmap_free", {Type::I64}, Type::Void, s);
    addSig("bitmap_width", {Type::I64}, Type::I64, s);
    addSig("bitmap_height", {Type::I64}, Type::I64, s);
    addSig("bitmap_get", {Type::I64, Type::I64, Type::I64}, Type::I64, s);
    addSig("bitmap_set", {Type::I64, Type::I64, Type::I64, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("bitmap_save_ppm", {Type::I64, Type::Str}, Type::Bool, s);
    addSig("renderer_set_backend", {Type::Str}, Type::Bool, s);
    addSig("renderer_backend", {}, Type::Str, s);
    addSig("renderer_supports", {Type::Str}, Type::Bool, s);
    addSig("renderer_set_hardware_acceleration", {Type::Bool}, Type::Bool, s);
    addSig("renderer_hardware_acceleration_enabled", {}, Type::Bool, s);
    addSig("renderer_select_accelerated", {Type::Str}, Type::Bool, s);
    addSig("renderer_is_accelerated", {}, Type::Bool, s);
    ...
    addSig("game_set_fullscreen", {Type::I64, Type::Bool}, Type::Void, s);
    addSig("game_is_fullscreen", {Type::I64}, Type::Bool, s);
    addSig("game_set_window_mode", {Type::I64, Type::Str}, Type::Bool, s);
    addSig("game_window_mode", {Type::I64}, Type::Str, s);
    addSig("game_set_windowed", {Type::I64}, Type::Void, s);
    addSig("game_set_windowed_fullscreen", {Type::I64}, Type::Void, s);
    addSig("game_set_fullscreen_mode", {Type::I64}, Type::Void, s);
    addSig("game_set_interpolation", {Type::I64, Type::Bool}, Type::Void, s);
    addSig("game_interpolation_enabled", {Type::I64}, Type::Bool, s);
    addSig("game_set_interpolation_alpha", {Type::I64, Type::F64}, Type::Void, s);
    addSig("game_interpolation_alpha", {Type::I64}, Type::F64, s);
    addSig("game_interpolated_delta", {Type::I64}, Type::F64, s);
    ...
    addSig("game_draw_bitmap", {Type::I64, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("game_text", {Type::I64, Type::I64, Type::I64, Type::Str, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("game_text_width", {Type::Str}, Type::I64, s);
    ...
    addSig("pg_set_fullscreen", {Type::I64, Type::Bool}, Type::Void, s);
    addSig("pg_is_fullscreen", {Type::I64}, Type::Bool, s);
    addSig("pg_set_window_mode", {Type::I64, Type::Str}, Type::Bool, s);
    addSig("pg_window_mode", {Type::I64}, Type::Str, s);
    addSig("pg_set_windowed", {Type::I64}, Type::Void, s);
    addSig("pg_set_windowed_fullscreen", {Type::I64}, Type::Void, s);
    addSig("pg_set_fullscreen_mode", {Type::I64}, Type::Void, s);
    addSig("pg_set_interpolation", {Type::I64, Type::Bool}, Type::Void, s);
    addSig("pg_interpolation_enabled", {Type::I64}, Type::Bool, s);
    addSig("pg_set_interpolation_alpha", {Type::I64, Type::F64}, Type::Void, s);
    addSig("pg_interpolation_alpha", {Type::I64}, Type::F64, s);
    addSig("pg_interpolated_delta", {Type::I64}, Type::F64, s);
    ...
    addSig("pg_draw_bitmap", {Type::I64, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("pg_draw_text", {Type::I64, Type::I64, Type::I64, Type::Str, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    ...
    addSig("pg_surface_draw_bitmap", {Type::I64, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("pg_surface_text", {Type::I64, Type::I64, Type::I64, Type::Str, Type::I64, Type::I64, Type::I64}, Type::Void, s);
    addSig("pg_load_bitmap", {Type::Str}, Type::I64, s);
    addSig("pg_bitmap_free", {Type::I64}, Type::Void, s);
  ...
  static std::string ownedFreeFnForCtor(const Expr &initExpr) {
    ...
    if (c.f == "gfx_new" || c.f == "pg_surface_new" || c.f == "bitmap_new" || c.f == "bitmap_load") return "gfx_free";
...
public:
  ...
  std::string run() {
    ...
    o_ << "#endif\n\n";
    o_ << "#if defined(_OPENMP) && defined(__has_include)\n";
    o_ << "#if __has_include(<omp.h>)\n";
    o_ << "#include <omp.h>\n";
    o_ << "#define LS_HAS_OMP_H 1\n";
    o_ << "#endif\n";
    o_ << "#endif\n\n";
...
private:
  ...
  void emitBuiltins() {
    ...
    o_ << "}\n";
    o_ << "static inline int64_t bitmap_new(int64_t w, int64_t h) { return gfx_new(w, h); }\n";
    o_ << "static inline void bitmap_free(int64_t id) { gfx_free(id); }\n";
    o_ << "static inline int64_t bitmap_width(int64_t id) { return gfx_width(id); }\n";
    o_ << "static inline int64_t bitmap_height(int64_t id) { return gfx_height(id); }\n";
    o_ << "static inline int64_t bitmap_get(int64_t id, int64_t x, int64_t y) { return gfx_get(id, x, y); }\n";
    o_ << "static inline void bitmap_set(int64_t id, int64_t x, int64_t y, int64_t r, int64_t g, int64_t b) { gfx_set(id, x, y, r, g, b); }\n";
    o_ << "static inline ls_bool bitmap_save_ppm(int64_t id, const char *path) { return gfx_save_ppm(id, path); }\n";
    o_ << "static inline uint16_t ls_read_le16(const uint8_t *p) { return (uint16_t)p[0] | ((uint16_t)p[1] << 8); }\n";
    o_ << "static inline uint32_t ls_read_le32(const uint8_t *p) { return (uint32_t)p[0] | ((uint32_t)p[1] << 8) | ((uint32_t)p[2] << 16) | ((uint32_t)p[3] << 24); }\n";
    o_ << "static inline int64_t bitmap_load_bmp(const char *path) {\n";
    o_ << "  const char *p = path ? path : \"\";\n";
    o_ << "  if (p[0] == '\\0') return -1;\n";
    o_ << "  FILE *f = NULL;\n";
    o_ << "#if defined(_WIN32)\n";
    o_ << "  if (fopen_s(&f, p, \"rb\") != 0 || !f) return -1;\n";
    o_ << "#else\n";
    o_ << "  f = fopen(p, \"rb\");\n";
    o_ << "  if (!f) return -1;\n";
    o_ << "#endif\n";
    o_ << "  uint8_t h[54];\n";
    o_ << "  if (fread(h, 1, 54, f) != 54) { fclose(f); return -1; }\n";
    o_ << "  if (h[0] != 'B' || h[1] != 'M') { fclose(f); return -1; }\n";
    o_ << "  const uint32_t off = ls_read_le32(h + 10);\n";
    o_ << "  const uint32_t dib = ls_read_le32(h + 14);\n";
    o_ << "  const int32_t bw = (int32_t)ls_read_le32(h + 18);\n";
    o_ << "  const int32_t bh_raw = (int32_t)ls_read_le32(h + 22);\n";
    o_ << "  const uint16_t planes = ls_read_le16(h + 26);\n";
    o_ << "  const uint16_t bpp = ls_read_le16(h + 28);\n";
    o_ << "  const uint32_t comp = ls_read_le32(h + 30);\n";
    o_ << "  if (dib < 40 || bw <= 0 || bh_raw == 0 || planes != 1 || comp != 0 || (bpp != 24 && bpp != 32)) { fclose(f); return -1; }\n";
    o_ << "  const int64_t bh = bh_raw < 0 ? -(int64_t)bh_raw : (int64_t)bh_raw;\n";
    o_ << "  const int top_down = bh_raw < 0;\n";
    o_ << "  if (bw > 16384 || bh > 16384) { fclose(f); return -1; }\n";
    o_ << "  const int64_t id = gfx_new((int64_t)bw, bh);\n";
    o_ << "  if (id < 0) { fclose(f); return -1; }\n";
    o_ << "  ls_gfx *g = ls_get_gfx(id);\n";
    o_ << "  const size_t row_stride = ((((size_t)bw * (size_t)bpp) + 31u) / 32u) * 4u;\n";
    o_ << "  uint8_t *row = (uint8_t *)malloc(row_stride);\n";
    o_ << "  if (!g || !row || fseek(f, (long)off, SEEK_SET) != 0) { if (row) free(row); fclose(f); gfx_free(id); return -1; }\n";
    o_ << "  for (int64_t y = 0; y < bh; ++y) {\n";
    o_ << "    if (fread(row, 1, row_stride, f) != row_stride) { free(row); fclose(f); gfx_free(id); return -1; }\n";
    o_ << "    const int64_t dy = top_down ? y : (bh - 1 - y);\n";
    o_ << "    uint8_t *dst = g->pix + ((size_t)dy * (size_t)g->w * 3u);\n";
    o_ << "    const size_t step = (size_t)bpp / 8u;\n";
    o_ << "    for (int64_t x = 0; x < (int64_t)bw; ++x) {\n";
    o_ << "      const uint8_t *src = row + ((size_t)x * step);\n";
    o_ << "      dst[(size_t)x * 3u + 0u] = src[2];\n";
    o_ << "      dst[(size_t)x * 3u + 1u] = src[1];\n";
    o_ << "      dst[(size_t)x * 3u + 2u] = src[0];\n";
    o_ << "    }\n";
    o_ << "  }\n";
    o_ << "  free(row);\n";
    o_ << "  fclose(f);\n";
    o_ << "  return id;\n";
    o_ << "}\n";
    o_ << "static inline int ls_ppm_next_token(FILE *f, char *buf, size_t cap) {\n";
    o_ << "  int c = 0;\n";
    o_ << "  do {\n";
    o_ << "    c = fgetc(f);\n";
    o_ << "    if (c == '#') { while (c != EOF && c != '\\n') c = fgetc(f); }\n";
    o_ << "  } while (c != EOF && isspace((unsigned char)c));\n";
    o_ << "  if (c == EOF) return 0;\n";
    o_ << "  size_t n = 0;\n";
    o_ << "  while (c != EOF && !isspace((unsigned char)c)) {\n";
    o_ << "    if (c == '#') { while (c != EOF && c != '\\n') c = fgetc(f); break; }\n";
    o_ << "    if (n + 1 < cap) buf[n++] = (char)c;\n";
    o_ << "    c = fgetc(f);\n";
    o_ << "  }\n";
    o_ << "  if (cap > 0) buf[n] = '\\0';\n";
    o_ << "  return n > 0 ? 1 : 0;\n";
    o_ << "}\n";
    o_ << "static inline int64_t bitmap_load_ppm(const char *path) {\n";
    o_ << "  const char *p = path ? path : \"\";\n";
    o_ << "  if (p[0] == '\\0') return -1;\n";
    o_ << "  FILE *f = NULL;\n";
    o_ << "#if defined(_WIN32)\n";
    ...
    o_ << "#endif\n";
    o_ << "  char tok[64];\n";
    o_ << "  if (!ls_ppm_next_token(f, tok, sizeof(tok))) { fclose(f); return -1; }\n";
    o_ << "  const int ascii = strcmp(tok, \"P3\") == 0;\n";
    o_ << "  const int binary = strcmp(tok, \"P6\") == 0;\n";
    o_ << "  if (!ascii && !binary) { fclose(f); return -1; }\n";
    o_ << "  if (!ls_ppm_next_token(f, tok, sizeof(tok))) { fclose(f); return -1; }\n";
    o_ << "  const int64_t w = strtoll(tok, NULL, 10);\n";
    o_ << "  if (!ls_ppm_next_token(f, tok, sizeof(tok))) { fclose(f); return -1; }\n";
    o_ << "  const int64_t h = strtoll(tok, NULL, 10);\n";
    o_ << "  if (!ls_ppm_next_token(f, tok, sizeof(tok))) { fclose(f); return -1; }\n";
    o_ << "  const int64_t maxv = strtoll(tok, NULL, 10);\n";
    o_ << "  if (w <= 0 || h <= 0 || maxv <= 0 || maxv > 255) { fclose(f); return -1; }\n";
    o_ << "  const int64_t id = gfx_new(w, h);\n";
    o_ << "  if (id < 0) { fclose(f); return -1; }\n";
    o_ << "  ls_gfx *g = ls_get_gfx(id);\n";
    o_ << "  const size_t bytes = ((size_t)w * (size_t)h) * 3u;\n";
    o_ << "  if (binary) {\n";
    o_ << "    if (!g || fread(g->pix, 1, bytes, f) != bytes) { fclose(f); gfx_free(id); return -1; }\n";
    o_ << "  } else {\n";
    o_ << "    for (size_t i = 0; i < bytes; ++i) {\n";
    o_ << "      if (!ls_ppm_next_token(f, tok, sizeof(tok))) { fclose(f); gfx_free(id); return -1; }\n";
    o_ << "      g->pix[i] = ls_color_u8(strtoll(tok, NULL, 10));\n";
    o_ << "    }\n";
    o_ << "  }\n";
    o_ << "  fclose(f);\n";
    o_ << "  return id;\n";
    o_ << "}\n";
    o_ << "static inline int64_t bitmap_load(const char *path) {\n";
    o_ << "  int64_t id = bitmap_load_bmp(path);\n";
    o_ << "  if (id >= 0) return id;\n";
    o_ << "  return bitmap_load_ppm(path);\n";
    o_ << "}\n";
    o_ << "static inline void gfx_draw_bitmap(int64_t dst_id, int64_t src_id, int64_t dst_x, int64_t dst_y) {\n";
    o_ << "  ls_gfx *dst = ls_get_gfx(dst_id);\n";
    o_ << "  ls_gfx *src = ls_get_gfx(src_id);\n";
    o_ << "  if (!dst || !src || !dst->pix || !src->pix) return;\n";
    o_ << "  int64_t sx0 = 0, sy0 = 0, sx1 = src->w, sy1 = src->h;\n";
    o_ << "  if (dst_x < 0) sx0 = -dst_x;\n";
    o_ << "  if (dst_y < 0) sy0 = -dst_y;\n";
    o_ << "  if (dst_x + sx1 > dst->w) sx1 = dst->w - dst_x;\n";
    o_ << "  if (dst_y + sy1 > dst->h) sy1 = dst->h - dst_y;\n";
    o_ << "  if (sx0 >= sx1 || sy0 >= sy1) return;\n";
    o_ << "  for (int64_t y = sy0; y < sy1; ++y) {\n";
    o_ << "    uint8_t *dst_row = dst->pix + ((((size_t)(dst_y + y) * (size_t)dst->w) + (size_t)(dst_x + sx0)) * 3u);\n";
    o_ << "    const uint8_t *src_row = src->pix + ((((size_t)y * (size_t)src->w) + (size_t)sx0) * 3u);\n";
    o_ << "    memcpy(dst_row, src_row, (size_t)(sx1 - sx0) * 3u);\n";
    o_ << "  }\n";
    o_ << "}\n";
    o_ << "static inline uint8_t ls_font5x7_row(unsigned char ch, int row) {\n";
    o_ << "  if (ch >= 'a' && ch <= 'z') ch = (unsigned char)(ch - 32);\n";
    o_ << "  switch (ch) {\n";
    o_ << "  case 'A': { static const uint8_t r[7] = {14,17,17,31,17,17,17}; return r[row]; }\n";
    o_ << "  case 'B': { static const uint8_t r[7] = {30,17,17,30,17,17,30}; return r[row]; }\n";
    o_ << "  case 'C': { static const uint8_t r[7] = {14,17,16,16,16,17,14}; return r[row]; }\n";
    o_ << "  case 'D': { static const uint8_t r[7] = {30,17,17,17,17,17,30}; return r[row]; }\n";
    o_ << "  case 'E': { static const uint8_t r[7] = {31,16,16,30,16,16,31}; return r[row]; }\n";
    o_ << "  case 'F': { static const uint8_t r[7] = {31,16,16,30,16,16,16}; return r[row]; }\n";
    o_ << "  case 'G': { static const uint8_t r[7] = {14,17,16,23,17,17,14}; return r[row]; }\n";
    o_ << "  case 'H': { static const uint8_t r[7] = {17,17,17,31,17,17,17}; return r[row]; }\n";
    o_ << "  case 'I': { static const uint8_t r[7] = {14,4,4,4,4,4,14}; return r[row]; }\n";
    o_ << "  case 'J': { static const uint8_t r[7] = {1,1,1,1,17,17,14}; return r[row]; }\n";
    o_ << "  case 'K': { static const uint8_t r[7] = {17,18,20,24,20,18,17}; return r[row]; }\n";
    o_ << "  case 'L': { static const uint8_t r[7] = {16,16,16,16,16,16,31}; return r[row]; }\n";
    o_ << "  case 'M': { static const uint8_t r[7] = {17,27,21,21,17,17,17}; return r[row]; }\n";
    o_ << "  case 'N': { static const uint8_t r[7] = {17,25,21,19,17,17,17}; return r[row]; }\n";
    o_ << "  case 'O': { static const uint8_t r[7] = {14,17,17,17,17,17,14}; return r[row]; }\n";
    o_ << "  case 'P': { static const uint8_t r[7] = {30,17,17,30,16,16,16}; return r[row]; }\n";
    o_ << "  case 'Q': { static const uint8_t r[7] = {14,17,17,17,21,18,13}; return r[row]; }\n";
    o_ << "  case 'R': { static const uint8_t r[7] = {30,17,17,30,20,18,17}; return r[row]; }\n";
    o_ << "  case 'S': { static const uint8_t r[7] = {15,16,16,14,1,1,30}; return r[row]; }\n";
    o_ << "  case 'T': { static const uint8_t r[7] = {31,4,4,4,4,4,4}; return r[row]; }\n";
    o_ << "  case 'U': { static const uint8_t r[7] = {17,17,17,17,17,17,14}; return r[row]; }\n";
    o_ << "  case 'V': { static const uint8_t r[7] = {17,17,17,17,17,10,4}; return r[row]; }\n";
    o_ << "  case 'W': { static const uint8_t r[7] = {17,17,17,21,21,21,10}; return r[row]; }\n";
    o_ << "  case 'X': { static const uint8_t r[7] = {17,17,10,4,10,17,17}; return r[row]; }\n";
    o_ << "  case 'Y': { static const uint8_t r[7] = {17,17,10,4,4,4,4}; return r[row]; }\n";
    o_ << "  case 'Z': { static const uint8_t r[7] = {31,1,2,4,8,16,31}; return r[row]; }\n";
    o_ << "  case '0': { static const uint8_t r[7] = {14,17,19,21,25,17,14}; return r[row]; }\n";
    o_ << "  case '1': { static const uint8_t r[7] = {4,12,4,4,4,4,14}; return r[row]; }\n";
    o_ << "  case '2': { static const uint8_t r[7] = {14,17,1,2,4,8,31}; return r[row]; }\n";
    o_ << "  case '3': { static const uint8_t r[7] = {30,1,1,14,1,1,30}; return r[row]; }\n";
    o_ << "  case '4': { static const uint8_t r[7] = {2,6,10,18,31,2,2}; return r[row]; }\n";
    o_ << "  case '5': { static const uint8_t r[7] = {31,16,16,30,1,1,30}; return r[row]; }\n";
    o_ << "  case '6': { static const uint8_t r[7] = {14,16,16,30,17,17,14}; return r[row]; }\n";
    o_ << "  case '7': { static const uint8_t r[7] = {31,1,2,4,8,8,8}; return r[row]; }\n";
    o_ << "  case '8': { static const uint8_t r[7] = {14,17,17,14,17,17,14}; return r[row]; }\n";
    o_ << "  case '9': { static const uint8_t r[7] = {14,17,17,15,1,1,14}; return r[row]; }\n";
    o_ << "  case '.': return row == 6 ? 4 : 0;\n";
    o_ << "  case ':': return (row == 2 || row == 5) ? 4 : 0;\n";
    o_ << "  case '-': return row == 3 ? 31 : 0;\n";
    o_ << "  case '_': return row == 6 ? 31 : 0;\n";
    o_ << "  case '/': return row < 7 ? (uint8_t)(1u << (6 - row > 4 ? 4 : 6 - row)) : 0;\n";
    o_ << "  case '!': return row < 5 ? 4 : (row == 6 ? 4 : 0);\n";
    o_ << "  case '?': { static const uint8_t r[7] = {14,17,1,2,4,0,4}; return r[row]; }\n";
    o_ << "  case ' ': return 0;\n";
    o_ << "  default: return (row == 0 || row == 6) ? 31 : 17;\n";
    o_ << "  }\n";
    o_ << "}\n";
    o_ << "static inline void ls_draw_text_pixels(uint8_t *pix, int64_t w, int64_t h, int64_t x, int64_t y, const char *text, uint8_t r, uint8_t g, uint8_t b) {\n";
    o_ << "  if (!pix || !text) return;\n";
    o_ << "  int64_t pen = x;\n";
    o_ << "  for (const unsigned char *s = (const unsigned char *)text; *s; ++s, pen += 6) {\n";
    o_ << "    if (*s == '\\n') { pen = x; y += 8; continue; }\n";
    o_ << "    for (int row = 0; row < 7; ++row) {\n";
    o_ << "      const int64_t yy = y + row;\n";
    o_ << "      if ((uint64_t)yy >= (uint64_t)h) continue;\n";
    o_ << "      const uint8_t bits = ls_font5x7_row(*s, row);\n";
    o_ << "      for (int col = 0; col < 5; ++col) {\n";
    o_ << "        if ((bits & (uint8_t)(1u << (4 - col))) == 0) continue;\n";
    o_ << "        const int64_t xx = pen + col;\n";
    o_ << "        if ((uint64_t)xx >= (uint64_t)w) continue;\n";
    o_ << "        const size_t idx = (((size_t)yy * (size_t)w) + (size_t)xx) * 3u;\n";
    o_ << "        pix[idx] = r; pix[idx + 1] = g; pix[idx + 2] = b;\n";
    o_ << "      }\n";
    o_ << "    }\n";
    o_ << "  }\n";
    o_ << "}\n";
    o_ << "static inline void gfx_text(int64_t id, int64_t x, int64_t y, const char *text, int64_t r, int64_t g, int64_t b) {\n";
    o_ << "  ls_gfx *dst = ls_get_gfx(id);\n";
    o_ << "  if (!dst || !dst->pix) return;\n";
    o_ << "  ls_draw_text_pixels(dst->pix, dst->w, dst->h, x, y, text, ls_color_u8(r), ls_color_u8(g), ls_color_u8(b));\n";
    o_ << "}\n";
    o_ << "static inline int64_t gfx_text_width(const char *text) { return text ? (int64_t)strlen(text) * 6 : 0; }\n";
    o_ << "static inline int ls_cstr_ieq(const char *a, const char *b) {\n";
    o_ << "  if (!a || !b) return 0;\n";
    o_ << "  while (*a && *b) {\n";
    o_ << "    if (tolower((unsigned char)*a) != tolower((unsigned char)*b)) return 0;\n";
    o_ << "    ++a; ++b;\n";
    o_ << "  }\n";
    o_ << "  return *a == '\\0' && *b == '\\0';\n";
    o_ << "}\n";
    o_ << "static int ls_renderer_backend_code = 0;\n";
    o_ << "static ls_bool ls_renderer_hardware_requested = 0;\n";
    o_ << "static inline int ls_renderer_code_from_name(const char *name) {\n";
    o_ << "  if (!name) return -1;\n";
    ...
    o_ << "static inline ls_bool renderer_select_accelerated(const char *preferred) {\n";
    o_ << "  const char *name = (preferred && preferred[0]) ? preferred : \"opengl\";\n";
    o_ << "  int c = ls_renderer_code_from_name(name);\n";
    o_ << "  if (c <= 0) return 0;\n";
    o_ << "  ls_renderer_backend_code = c;\n";
    o_ << "  ls_renderer_hardware_requested = 1;\n";
    o_ << "  return 1;\n";
    o_ << "}\n";
    o_ << "static inline ls_bool renderer_is_accelerated(void) { return (ls_renderer_hardware_requested && ls_renderer_backend_code != 0) ? 1 : 0; }\n";
    ...
    o_ << "  int window_mode;\n";
    o_ << "  ls_bool interpolation;\n";
    o_ << "  double interpolation_alpha;\n";
    o_ << "  double interpolated_dt;\n";
    o_ << "  double fixed_dt;\n";
    o_ << "  double dt;\n";
    o_ << "  int64_t frame;\n";
    o_ << "  double mouse_x;\n";
    ...
    o_ << "#if defined(_WIN32)\n";
    o_ << "  ls_bool fullscreen;\n";
    o_ << "  HWND hwnd;\n";
    o_ << "  HDC hdc;\n";
    o_ << "  BITMAPINFO bmi;\n";
    o_ << "  DWORD windowed_style;\n";
    o_ << "  DWORD windowed_ex_style;\n";
    o_ << "  RECT windowed_rect;\n";
    ...
    o_ << "}\n";
    o_ << "#endif\n";
    o_ << "static inline int ls_game_window_mode_code(const char *mode) {\n";
    o_ << "  if (!mode) return -1;\n";
    o_ << "  if (ls_cstr_ieq(mode, \"windowed\") || ls_cstr_ieq(mode, \"window\")) return 0;\n";
    o_ << "  if (ls_cstr_ieq(mode, \"fullscreen\") || ls_cstr_ieq(mode, \"exclusive_fullscreen\")) return 1;\n";
    o_ << "  if (ls_cstr_ieq(mode, \"windowed_fullscreen\") || ls_cstr_ieq(mode, \"borderless\") || ls_cstr_ieq(mode, \"borderless_fullscreen\")) return 2;\n";
    o_ << "  return -1;\n";
    o_ << "}\n";
    o_ << "static inline const char *ls_game_window_mode_name(int mode) {\n";
    o_ << "  return mode == 1 ? \"fullscreen\" : (mode == 2 ? \"windowed_fullscreen\" : \"windowed\");\n";
    o_ << "}\n";
    o_ << "static inline void ls_game_update_interpolated_dt(ls_game *g, double prev_dt) {\n";
    o_ << "  if (!g) return;\n";
    o_ << "  if (!isfinite(prev_dt) || prev_dt < 0.0) prev_dt = g->dt;\n";
    o_ << "  if (!g->interpolation) { g->interpolated_dt = g->dt; return; }\n";
    o_ << "  double a = g->interpolation_alpha;\n";
    o_ << "  if (!isfinite(a)) a = 0.5;\n";
    o_ << "  if (a < 0.0) a = 0.0;\n";
    o_ << "  if (a > 1.0) a = 1.0;\n";
    o_ << "  g->interpolated_dt = prev_dt + ((g->dt - prev_dt) * a);\n";
    o_ << "}\n";
    ...
    o_ << "  g->target_fps = 60;\n";
    o_ << "  g->window_mode = 0;\n";
    o_ << "  g->interpolation = 0;\n";
    o_ << "  g->interpolation_alpha = 0.5;\n";
    o_ << "  g->fixed_dt = 0.0;\n";
    o_ << "  g->dt = 1.0 / 60.0;\n";
    o_ << "  g->interpolated_dt = g->dt;\n";
    o_ << "  g->frame = 0;\n";
    o_ << "  g->mouse_x = 0.0;\n";
    o_ << "  g->mouse_y = 0.0;\n";
    ...
    o_ << "#if defined(_WIN32)\n";
    o_ << "  g->fullscreen = 0;\n";
    o_ << "  g->windowed_style = WS_OVERLAPPEDWINDOW;\n";
    o_ << "  g->windowed_ex_style = 0;\n";
    o_ << "  g->windowed_rect.left = 0;\n";
    o_ << "  g->windowed_rect.top = 0;\n";
    o_ << "  g->windowed_rect.right = (LONG)w;\n";
    o_ << "  g->windowed_rect.bottom = (LONG)h;\n";
    ...
    o_ << "    g->windowed_style = (DWORD)GetWindowLongPtrA(g->hwnd, GWL_STYLE);\n";
    o_ << "    g->windowed_ex_style = (DWORD)GetWindowLongPtrA(g->hwnd, GWL_EXSTYLE);\n";
    o_ << "    (void)GetWindowRect(g->hwnd, &g->windowed_rect);\n";
    ...
    o_ << "  g->fixed_dt = dt;\n";
    o_ << "}\n";
    o_ << "static inline ls_bool game_set_window_mode(int64_t id, const char *mode) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g) return 0;\n";
    o_ << "  const int code = ls_game_window_mode_code(mode);\n";
    o_ << "  if (code < 0) return 0;\n";
    o_ << "  g->window_mode = code;\n";
    o_ << "#if defined(_WIN32)\n";
    o_ << "  if (g->headless || !g->hwnd) return 1;\n";
    o_ << "  if (code != 0) {\n";
    o_ << "    if (!g->fullscreen) {\n";
    o_ << "      g->windowed_style = (DWORD)GetWindowLongPtrA(g->hwnd, GWL_STYLE);\n";
    o_ << "      g->windowed_ex_style = (DWORD)GetWindowLongPtrA(g->hwnd, GWL_EXSTYLE);\n";
    ...
    o_ << "    }\n";
    o_ << "    MONITORINFO mi;\n";
    o_ << "    memset(&mi, 0, sizeof(mi));\n";
    o_ << "    mi.cbSize = sizeof(mi);\n";
    o_ << "    HMONITOR mon = MonitorFromWindow(g->hwnd, MONITOR_DEFAULTTONEAREST);\n";
    o_ << "    SetWindowLongPtrA(g->hwnd, GWL_STYLE, (LONG_PTR)(WS_POPUP | WS_VISIBLE));\n";
    o_ << "    SetWindowLongPtrA(g->hwnd, GWL_EXSTYLE, (LONG_PTR)0);\n";
    o_ << "    if (GetMonitorInfoA(mon, &mi)) {\n";
    o_ << "      RECT r = mi.rcMonitor;\n";
    o_ << "      SetWindowPos(g->hwnd, HWND_TOP, r.left, r.top, r.right - r.left, r.bottom - r.top,\n";
    o_ << "                   SWP_FRAMECHANGED | SWP_SHOWWINDOW);\n";
    o_ << "    } else {\n";
    o_ << "      ShowWindow(g->hwnd, SW_MAXIMIZE);\n";
    o_ << "    }\n";
    o_ << "    g->fullscreen = 1;\n";
    o_ << "    return 1;\n";
    o_ << "  }\n";
    o_ << "  if (g->fullscreen) {\n";
    o_ << "    SetWindowLongPtrA(g->hwnd, GWL_STYLE, (LONG_PTR)g->windowed_style);\n";
    o_ << "    SetWindowLongPtrA(g->hwnd, GWL_EXSTYLE, (LONG_PTR)g->windowed_ex_style);\n";
    o_ << "    RECT wr = g->windowed_rect;\n";
    o_ << "    int ww = (int)(wr.right - wr.left);\n";
    o_ << "    int wh = (int)(wr.bottom - wr.top);\n";
    o_ << "    if (ww <= 0 || wh <= 0) {\n";
    o_ << "      RECT cr;\n";
    o_ << "      cr.left = 0;\n";
    o_ << "      cr.top = 0;\n";
    o_ << "      cr.right = (LONG)g->w;\n";
    o_ << "      cr.bottom = (LONG)g->h;\n";
    o_ << "      (void)AdjustWindowRectEx(&cr, g->windowed_style ? g->windowed_style : WS_OVERLAPPEDWINDOW, 0,\n";
    o_ << "                               g->windowed_ex_style);\n";
    o_ << "      ww = cr.right - cr.left;\n";
    o_ << "      wh = cr.bottom - cr.top;\n";
    o_ << "    }\n";
    o_ << "    SetWindowPos(g->hwnd, HWND_NOTOPMOST, wr.left, wr.top, ww, wh, SWP_FRAMECHANGED | SWP_SHOWWINDOW);\n";
    o_ << "    g->fullscreen = 0;\n";
    o_ << "  }\n";
    o_ << "#endif\n";
    o_ << "  return 1;\n";
    o_ << "}\n";
    o_ << "static inline const char *game_window_mode(int64_t id) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  return g ? ls_game_window_mode_name(g->window_mode) : \"windowed\";\n";
    o_ << "}\n";
    o_ << "static inline void game_set_windowed(int64_t id) { (void)game_set_window_mode(id, \"windowed\"); }\n";
    o_ << "static inline void game_set_windowed_fullscreen(int64_t id) { (void)game_set_window_mode(id, \"windowed_fullscreen\"); }\n";
    o_ << "static inline void game_set_fullscreen_mode(int64_t id) { (void)game_set_window_mode(id, \"fullscreen\"); }\n";
    o_ << "static inline void game_set_fullscreen(int64_t id, ls_bool enabled) { (void)game_set_window_mode(id, enabled ? \"fullscreen\" : \"windowed\"); }\n";
    o_ << "static inline ls_bool game_is_fullscreen(int64_t id) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g) return 0;\n";
    o_ << "#if defined(_WIN32)\n";
    o_ << "  return (!g->headless && g->fullscreen) ? 1 : 0;\n";
    o_ << "#else\n";
    o_ << "  return 0;\n";
    o_ << "#endif\n";
    o_ << "}\n";
    o_ << "static inline void game_set_interpolation(int64_t id, ls_bool enabled) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g) return;\n";
    o_ << "  g->interpolation = enabled ? 1 : 0;\n";
    o_ << "  if (!g->interpolation) g->interpolated_dt = g->dt;\n";
    o_ << "}\n";
    o_ << "static inline ls_bool game_interpolation_enabled(int64_t id) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  return (g && g->interpolation) ? 1 : 0;\n";
    o_ << "}\n";
    o_ << "static inline void game_set_interpolation_alpha(int64_t id, double alpha) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g) return;\n";
    o_ << "  if (!isfinite(alpha)) alpha = 0.5;\n";
    o_ << "  if (alpha < 0.0) alpha = 0.0;\n";
    o_ << "  if (alpha > 1.0) alpha = 1.0;\n";
    o_ << "  g->interpolation_alpha = alpha;\n";
    o_ << "}\n";
    o_ << "static inline double game_interpolation_alpha(int64_t id) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  return g ? g->interpolation_alpha : 0.0;\n";
    o_ << "}\n";
    o_ << "static inline double game_interpolated_delta(int64_t id) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  return g ? g->interpolated_dt : 0.0;\n";
    o_ << "}\n";
    ...
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g) return;\n";
    o_ << "  const double prev_dt = g->dt;\n";
    o_ << "  game_poll(id);\n";
    o_ << "  if (g->fixed_dt > 0.0) {\n";
    o_ << "    g->dt = g->fixed_dt;\n";
    o_ << "    ls_game_update_interpolated_dt(g, prev_dt);\n";
    o_ << "    return;\n";
    o_ << "  }\n";
    o_ << "#if defined(_WIN32)\n";
    ...
    o_ << "  }\n";
    o_ << "}\n";
    o_ << "static inline void game_draw_bitmap(int64_t game_id, int64_t bitmap_id, int64_t dst_x, int64_t dst_y) {\n";
    o_ << "  game_draw_gfx(game_id, bitmap_id, dst_x, dst_y);\n";
    o_ << "}\n";
    o_ << "static inline void game_text(int64_t id, int64_t x, int64_t y, const char *text, int64_t r, int64_t gg, int64_t b) {\n";
    o_ << "  ls_game *g = ls_get_game(id);\n";
    o_ << "  if (!g || !g->pix) return;\n";
    o_ << "  ls_draw_text_pixels(g->pix, g->w, g->h, x, y, text, ls_color_u8(r), ls_color_u8(gg), ls_color_u8(b));\n";
    o_ << "}\n";
    o_ << "static inline int64_t game_text_width(const char *text) { return gfx_text_width(text); }\n";
    ...
    o_ << "static inline void pg_set_fullscreen(int64_t game, ls_bool enabled) { game_set_fullscreen(game, enabled); }\n";
    o_ << "static inline ls_bool pg_is_fullscreen(int64_t game) { return game_is_fullscreen(game); }\n";
    o_ << "static inline ls_bool pg_set_window_mode(int64_t game, const char *mode) { return game_set_window_mode(game, mode); }\n";
    o_ << "static inline const char *pg_window_mode(int64_t game) { return game_window_mode(game); }\n";
    o_ << "static inline void pg_set_windowed(int64_t game) { game_set_windowed(game); }\n";
    o_ << "static inline void pg_set_windowed_fullscreen(int64_t game) { game_set_windowed_fullscreen(game); }\n";
    o_ << "static inline void pg_set_fullscreen_mode(int64_t game) { game_set_fullscreen_mode(game); }\n";
    o_ << "static inline void pg_set_interpolation(int64_t game, ls_bool enabled) { game_set_interpolation(game, enabled); }\n";
    o_ << "static inline ls_bool pg_interpolation_enabled(int64_t game) { return game_interpolation_enabled(game); }\n";
    o_ << "static inline void pg_set_interpolation_alpha(int64_t game, double alpha) { game_set_interpolation_alpha(game, alpha); }\n";
    o_ << "static inline double pg_interpolation_alpha(int64_t game) { return game_interpolation_alpha(game); }\n";
    o_ << "static inline double pg_interpolated_delta(int64_t game) { return game_interpolated_delta(game); }\n";
    ...
    o_ << "static inline void pg_draw_bitmap(int64_t game, int64_t bitmap, int64_t x, int64_t y) { game_draw_bitmap(game, bitmap, x, y); }\n";
    o_ << "static inline void pg_draw_text(int64_t game, int64_t x, int64_t y, const char *text, int64_t r, int64_t g, int64_t b) { game_text(game, x, y, text, r, g, b); }\n";
    ...
    o_ << "static inline void pg_surface_draw_bitmap(int64_t surface, int64_t bitmap, int64_t x, int64_t y) { gfx_draw_bitmap(surface, bitmap, x, y); }\n";
    o_ << "static inline void pg_surface_text(int64_t surface, int64_t x, int64_t y, const char *text, int64_t r, int64_t g, int64_t b) { gfx_text(surface, x, y, text, r, g, b); }\n";
    o_ << "static inline int64_t pg_load_bitmap(const char *path) { return bitmap_load(path); }\n";
    o_ << "static inline void pg_bitmap_free(int64_t bitmap) { bitmap_free(bitmap); }\n";
    ...
    o_ << "  ls_su_emit_debug(buf);\n";
    o_ << "}\n";
    o_ << "static int64_t ls_task_worker_override = 0;\n";
    o_ << "static ls_bool ls_task_use_hyperthreading = 1;\n";
    o_ << "static inline int64_t task_hardware_threads(void) {\n";
    o_ << "#if defined(_WIN32)\n";
    o_ << "  SYSTEM_INFO si;\n";
    o_ << "  GetSystemInfo(&si);\n";
    o_ << "  return si.dwNumberOfProcessors > 0 ? (int64_t)si.dwNumberOfProcessors : 1;\n";
    o_ << "#else\n";
    o_ << "  long n = sysconf(_SC_NPROCESSORS_ONLN);\n";
    o_ << "  return n > 0 ? (int64_t)n : 1;\n";
    o_ << "#endif\n";
    o_ << "}\n";
    o_ << "static inline int64_t ls_task_default_workers(void) {\n";
    o_ << "  int64_t n = task_hardware_threads();\n";
    o_ << "  if (n < 1) n = 1;\n";
    o_ << "  if (!ls_task_use_hyperthreading && n > 1) n = (n + 1) / 2;\n";
    o_ << "  return n < 1 ? 1 : n;\n";
    o_ << "}\n";
    o_ << "static inline int64_t task_worker_count(void) {\n";
    o_ << "  return ls_task_worker_override > 0 ? ls_task_worker_override : ls_task_default_workers();\n";
    o_ << "}\n";
    o_ << "static inline void task_set_worker_count(int64_t count) {\n";
    o_ << "  if (count < 0) count = 0;\n";
    o_ << "  if (count > 4096) count = 4096;\n";
    o_ << "  ls_task_worker_override = count;\n";
    o_ << "#if defined(LS_HAS_OMP_H)\n";
    o_ << "  omp_set_num_threads((int)task_worker_count());\n";
    o_ << "#endif\n";
    o_ << "}\n";
    o_ << "static inline void task_set_hyperthreading(ls_bool enabled) {\n";
    o_ << "  ls_task_use_hyperthreading = enabled ? 1 : 0;\n";
    o_ << "#if defined(LS_HAS_OMP_H)\n";
    o_ << "  if (ls_task_worker_override <= 0) omp_set_num_threads((int)task_worker_count());\n";
    o_ << "#endif\n";
    o_ << "}\n";
    o_ << "static inline ls_bool task_hyperthreading_enabled(void) { return ls_task_use_hyperthreading ? 1 : 0; }\n";
...
static Opt parseOpt(int argc, char **argv) {
  ...
  for (int i = 1; i < argc; ++i) {
    ...
    if (a == "--help") {
      ...
      o.infoMessages.push_back("LineScript version " + lineScriptVersionDisplay() + " (" + kLineScriptCodename + " update)");
...
int main(int argc, char **argv) {
  ...
  try {
    ...
    if (o.incremental && !o.noCache && !o.inputs.empty() && o.cliFlags.empty() && o.cliCustomTokens.empty()) {
    ...
    if (!o.cliFlags.empty()) {
      ...
      for (const std::string &rawFlag : o.cliFlags) {
        ...
        if (!ls::isValidCliFlagBody(body)) {
          std::cout << "Warning: bad flag '" << rawFlag << "' ignored\n";
          continue;
        }
        ...
        if (!ls::isKnownInfoFlagBody(body)) {
          std::cout << "Warning: undefined flag '" << rawFlag << "'\n";
        }
      }
    }
    if (!p.top.empty()) {
