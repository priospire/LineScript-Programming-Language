...
const BUILTIN_ARITY = new Map([
  ...
  ["task_hardware_threads", { min: 0, max: 0 }],
  ["task_set_worker_count", { min: 1, max: 1 }],
  ["task_worker_count", { min: 0, max: 0 }],
  ["task_set_hyperthreading", { min: 1, max: 1 }],
  ["task_hyperthreading_enabled", { min: 0, max: 0 }],
  ["renderer_set_backend", { min: 1, max: 1 }],
  ["renderer_backend", { min: 0, max: 0 }],
  ["renderer_supports", { min: 1, max: 1 }],
  ["renderer_set_hardware_acceleration", { min: 1, max: 1 }],
  ["renderer_hardware_acceleration_enabled", { min: 0, max: 0 }],
  ["renderer_select_accelerated", { min: 1, max: 1 }],
  ["renderer_is_accelerated", { min: 0, max: 0 }],
  ["game_set_window_mode", { min: 2, max: 2 }],
  ["game_window_mode", { min: 1, max: 1 }],
  ["game_set_windowed", { min: 1, max: 1 }],
  ["game_set_windowed_fullscreen", { min: 1, max: 1 }],
  ["game_set_fullscreen_mode", { min: 1, max: 1 }],
  ["game_set_interpolation", { min: 2, max: 2 }],
  ["game_interpolation_enabled", { min: 1, max: 1 }],
  ["game_set_interpolation_alpha", { min: 2, max: 2 }],
  ["game_interpolation_alpha", { min: 1, max: 1 }],
  ["game_interpolated_delta", { min: 1, max: 1 }],
  ["pg_set_window_mode", { min: 2, max: 2 }],
  ["pg_window_mode", { min: 1, max: 1 }],
  ["pg_set_windowed", { min: 1, max: 1 }],
  ["pg_set_windowed_fullscreen", { min: 1, max: 1 }],
  ["pg_set_fullscreen_mode", { min: 1, max: 1 }],
  ["pg_set_interpolation", { min: 2, max: 2 }],
  ["pg_interpolation_enabled", { min: 1, max: 1 }],
  ["pg_set_interpolation_alpha", { min: 2, max: 2 }],
  ["pg_interpolation_alpha", { min: 1, max: 1 }],
  ["pg_interpolated_delta", { min: 1, max: 1 }],
